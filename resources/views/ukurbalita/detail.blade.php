...
@section('container')
    ...
    <div class="d-sm-flex align-items-center mb-4">
        <a href="/ukur-balita" class="btn btn-dark btn-sm rounded-circle mr-2"><i class="fas fa-arrow-left"></i></a>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle  text-muted mt-2">Usia pengukuran: {{ $ukurbalita->usia_ukur }} bulan.</h6>
                    <h6 class="card-subtitle  text-muted mt-2">Jenis kelamin:
                        {{ $ukurbalita->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}</h6>
                    ...
                    <table class="table tablestripped">
                        ...
                        <tbody>
                            <tr>
                                <td class="{{ $class1 }} font-weight-bold">Berat Badan {{ $ukurbalita->sberat }}</td>
                                <td class="{{ $class2 }} font-weight-bold">Tinggi Badan {{ $ukurbalita->stinggi }}
                                </td>
                                <td class="{{ $class4 }} font-weight-bold">Lebar Kepala {{ $ukurbalita->skepala }}
                                </td>
                                <td class="{{ $class3 }} font-weight-bold">{{ $ukurbalita->sgizi }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <p class="card-text mt-2"><small class="text-muted">Bulan pengukuran:
                            {{ $ukurbalita->bulan }} {{ $ukurbalita->tahun }}</small></p>
                </div>

                <!-- Collapsable Card Berat -->
                <div class="card shadow mb-2">
                    <!-- Card Header - Accordion -->
                    <a href="#collapseCardBerat" class="d-block card-header py-3 bg-gradient-success" data-toggle="collapse"
                        role="button">
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $b->bb }} kg</td>
                                        <td><span
                                                class=" {{ $b->sberat == 'Risiko BB lebih' || $b->sberat == 'Sangat kurang' ? 'text-danger font-weight-bold' : '' }}
                ...
                <div class="card shadow mb-2">
                    <!-- Card Header - Accordion -->
                    <a href="#collapseCardTinggi" class="d-block card-header py-3 bg-gradient-warning"
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $t->pengukuran }}</td>
                                        <td><span
                                                class=" {{ $t->stinggi == 'Sangat pendek' || $t->stinggi == 'Tinggi' ? 'text-danger font-weight-bold' : '' }}
                ...
                <div class="card shadow mb-2">
                    <!-- Card Header - Accordion -->
                    <a href="#collapseCardGizi" class="d-block card-header py-3 bg-gradient-primary" data-toggle="collapse"
                        role="button">
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $g->pengukuran }}</td>
                                        <td><span
                                                class=" {{ $g->sgizi == 'Gizi buruk' || $g->sgizi == 'Obesitas' ? 'text-danger font-weight-bold' : '' }}
                                      {{ $g->sgizi == 'Gizi kurang' || $g->sgizi == 'Berisiko gizi lebih' || $g->sgizi == 'Gizi lebih' ? 'text-warning font-weight-bold' : '' }}
                                      {{ $g->sgizi == 'Gizi baik' ? 'text-success font-weight-bold' : '' }}">{{ $g->sgizi }}</span>
                                        </td>
                                        <td>{{ $g->jarak }}</td>
                                    </tr>
                                    <?php endforeach ?>
                ...
                <div class="card shadow ">
                    <!-- Card Header - Accordion -->
                    <a href="#collapseCardLebarKepala" class="d-block card-header py-3 bg-gradient-info"
                        data-toggle="collapse" role="button">
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $t->lk }} cm</td>
                                        <td><span
                                                class=" {{ $t->skepala == 'Terlalu kecil' || $t->skepala == 'Terlalu besar' ? 'text-danger font-weight-bold' : '' }}
                                      {{ $t->skepala == 'Normal' ? 'text-success font-weight-bold' : '' }} ">{{ $t->skepala }}</span>
                                        </td>
                                        <td>{{ $t->jarak }}</td>
                                    </tr>
                                    <?php endforeach ?>
